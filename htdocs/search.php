    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link " href="mybook.php">
      ...
      <table class="table">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    {
                    ?>
                      <form action="borrow.php" method="POST"><button type="submit" class="btn btn-sm btn-primary" name="submit" value="<?php echo $array[0];?>">借書</button></form>
                    <?php
                    }
                    else
                    {
                    ?>
                      <form action="wantborrow.php" method="POST"><button type="submit" class="btn btn-sm btn-secondary" name="submit" value="<?php echo $array[0];?>">被借走</button></form>
                    <?php
                    }
                    ?>
                    </td>
